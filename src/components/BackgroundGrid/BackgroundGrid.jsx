...
const BackgroundGrid = ({ children }) => {
  ...
  return (
    <div ref={containerRef} className="bg-mesh-grid min-h-screen relative w-full">
      ...
      {/* Dynamic scanline overlay for tech feel */}
      <div 
        className="absolute inset-0 pointer-events-none z-[2]" 
        style={{
          background: 'linear-gradient(rgba(64, 46, 50, 0) 50%, rgba(64, 46, 50, 0.15) 50%), linear-gradient(90deg, rgba(241, 131, 33, 0.04), rgba(131, 40, 0, 0.02), rgba(241, 131, 33, 0.04))',
