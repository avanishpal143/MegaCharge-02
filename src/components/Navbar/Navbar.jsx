    ...
    <nav className={`navbar-container ${shouldFloat ? 'navbar-scrolled' : 'navbar-transparent'}`}>
      <div className="navbar-inner max-w-7xl mx-auto px-6 h-20 flex items-center justify-between relative">
        ...
        <div className="hidden lg:flex items-center gap-8 h-full">
          <Link to="/" className={`nav-link ${location.pathname === '/' ? 'active-link text-[#00B4D8]' : ''}`}>Home</Link>
          <Link to="/products" className={`nav-link ${location.pathname === '/products' ? 'active-link text-[#00B4D8]' : ''}`}>Charger Models</Link>
          <Link to="/solutions" className={`nav-link ${location.pathname === '/solutions' ? 'active-link text-[#00B4D8]' : ''}`}>Rental Solutions</Link>
          <Link to="/franchise" className={`nav-link ${location.pathname === '/franchise' ? 'active-link text-[#00B4D8]' : ''}`}>Rental Franchise</Link>
          <Link to="/contact" className={`nav-link ${location.pathname === '/contact' ? 'active-link text-[#00B4D8]' : ''}`}>Contact</Link>
        </div>
        ...
        {isMobileMenuOpen && (
          <div className="mobile-menu-panel lg:hidden">
            <Link to="/" className="text-white text-base font-semibold hover:text-[#00B4D8] transition-colors py-2.5 border-b border-slate-800 border-opacity-40">Home</Link>
            <Link to="/products" className="text-white text-base font-semibold hover:text-[#00B4D8] transition-colors py-2.5 border-b border-slate-800 border-opacity-40">Charger Models</Link>
            <Link to="/solutions" className="text-white text-base font-semibold hover:text-[#00B4D8] transition-colors py-2.5 border-b border-slate-800 border-opacity-40">Rental Solutions</Link>
            <Link to="/franchise" className="text-white text-base font-semibold hover:text-[#00B4D8] transition-colors py-2.5 border-b border-slate-800 border-opacity-40">Rental Franchise</Link>
            <Link to="/contact" className="text-white text-base font-semibold hover:text-[#00B4D8] transition-colors py-2.5">Contact</Link>
            <Link to="/contact" className="border border-[#00B4D8] text-[#00B4D8] hover:bg-[#00B4D8] hover:text-white px-6 py-3 rounded-full font-bold transition-all duration-300 text-sm text-center mt-3 shadow-[0_0_15px_rgba(0,180,216,0.25)]">
              Rent a Station
            </Link>
          </div>
        )}
